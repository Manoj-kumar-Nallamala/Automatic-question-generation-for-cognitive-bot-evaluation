...
def entity_recognizer():                            ##This function recognizes various entitytypes by merging 2 stanford classifiers
   ...
   with open('Downloads/stanford-ner/7class.txt', 'r') as file:    ##LOading the file with names and entity types of 7 classes
       data7 = file.read().replace('\n', '')
   with open('Downloads/stanford-ner/4class.txt', 'r') as file:    ##LOading the file with names and entity types of 4 classes
...
def main():
     with open('Downloads/stanford-ner/sample.txt', 'r') as file:
